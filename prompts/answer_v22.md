...
## v4.3 composition contract
- Compose the final response through the structured answer plan rather than free-form prose.
- Keep each legal sentence bound to its retrieved citation and evidence node.
- Separate facts to verify, governing rules, application steps, and conclusions.
- Convert source-bound duties into an ordered practical checklist.
